...
% \begin{scope}[rotate=-30]
 ...
 \begin{scope}[ownOrange,ultra thick] % Draw in gray >>
...
\filldraw[ownOrange!40!white, draw=white!80!black,  ultra thick] (B1) -- (B3) -- (C3) -- (C1) --cycle;
 \filldraw[ownOrange!40!white, draw=white!80!black,  ultra thick] (B3) -- (B4) -- (C4) -- (C3) --cycle;

 \filldraw[ownOrange!60!white, draw=white!80!black,  ultra thick] (B2) -- (B4) -- (A4) -- (A2) --cycle;

\filldraw[ownOrange!60!white, draw=white!80!black,  ultra thick] (B2) -- (B4) -- (C4) -- (C2) --cycle;



\filldraw[ownOrange!60!white, draw=white!80!black,  ultra thick] (A1) -- (A3) -- (B3) -- (B1) --cycle;
\filldraw[ownOrange!60!white, draw=white!80!black,  ultra thick] (A1) -- (B1) -- (B2) -- (A2) --cycle;
\filldraw[ownOrange!60!white, draw=white!80!black,  ultra thick] (B1) -- (C1) -- (C2) -- (B2) --cycle;
%\draw[densely dotted, black](0,0,-3.5) -- (0,0,5);
\end{scope}



\begin{scope}[ownGreen]
	 \def\Rcirc{3}
	\def\lwidht{5}
    
    \tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}, line width=\lwidht]{\Rcirc}{0}
  %  \tdplotCsDrawLonCircle{2.5}{30}
  \tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}, line width=\lwidht]{\Rcirc}{45}
  \tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}, line width=\lwidht]{\Rcirc}{90}
  %  \tdplotCsDrawLonCircle{2.5}{120}
  \tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}, line width=\lwidht]{\Rcirc}{135}

    \tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}, line width=\lwidht]{\Rcirc}{-30}
      \tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}, line width=\lwidht]{\Rcirc}{-60}
        \tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}, line width=\lwidht]{\Rcirc}{0}
  \tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}, line width=\lwidht]{\Rcirc}{30}

  \tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}, line width=\lwidht]{\Rcirc}{60}

  
 \draw[tdplot_screen_coords, line width=\lwidht] (0,0,0) circle (\Rcirc); % Sphere outline
 

 \end{scope}

\begin{scope}[ownPurple]
	\def\Rcirc{4.5}
	\def\lwidht{4}
...
\begin{scope}[xshift=400]
	...
	\begin{scope}[rotate=-0]
		...
		\begin{scope}[ownBlue,ultra thick, rotate=0] % Draw in gray >>
			...
			\filldraw[ownBlue!40!white, draw=white!95!black,  ultra thick] (B1) -- (B3) -- (C3) -- (C1) --cycle;
			\filldraw[ownBlue!40!white, draw=white!95!black,  ultra thick] (B3) -- (B4) -- (C4) -- (C3) --cycle;
		...
		\begin{scope}[ownBlue,ultra thick, rotate=0]
			\filldraw[ownBlue!60!white, draw=white!95!black,  ultra thick] (B2) -- (B4) -- (A4) -- (A2) --cycle;
			
			\filldraw[ownBlue!60!white, draw=white!95!black,  ultra thick] (B2) -- (B4) -- (C4) -- (C2) --cycle;
			
			
			
			\filldraw[ownBlue!60!white, draw=white!95!black,  ultra thick] (A1) -- (A3) -- (B3) -- (B1) --cycle;
			\filldraw[ownBlue!60!white, draw=white!95!black,  ultra thick] (A1) -- (B1) -- (B2) -- (A2) --cycle;
			\filldraw[ownBlue!60!white, draw=white!95!black,  ultra thick] (B1) -- (C1) -- (C2) -- (B2) --cycle;
			% 
...
\node at (0,8,-9){\includegraphics[scale=0.4]{logo_darkmode_dipole}};
