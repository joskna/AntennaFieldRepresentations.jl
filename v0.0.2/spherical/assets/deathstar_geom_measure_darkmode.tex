...
% ________________________________________________________________________________________________________________
 \begin{document}
	...
	\begin{tikzpicture}[thick,tdplot_main_coords, scale=0.6, white!95!black] % TikZ picture >>
		\sphToCart{2.5}{-30}{40}
		...
		\begin{scope}[rotate=0]
			...
			\begin{scope}[ownOrange,thick, rotate=30] % Draw in gray >>
				...
				\filldraw[ownOrange!40!white, draw=white!95!black,  thick] (B1) -- (B3) -- (C3) -- (C1) --cycle;
				\filldraw[ownOrange!40!white, draw=white!95!black,  thick] (B3) -- (B4) -- (C4) -- (C3) --cycle;
				
				
				\draw[densely dotted, white!95!black](0,0,-3.5) -- (0,0,5);
			\end{scope}
			...
			\begin{scope}[ownBlue,thick, rotate=0, yshift=6cm] % Draw in gray >>
				...
				\draw[densely dotted, white!95!black](0,0,-10) -- (0,0,0);
				...
				\draw[densely dotted, white!95!black](0,0,0.4) -- (0,0,1.35);
			...
			\begin{scope}[ownOrange,thick, rotate=30]
				\filldraw[ownOrange!60!white, draw=white!95!black,  thick] (B2) -- (B4) -- (A4) -- (A2) --cycle;
				
				\filldraw[ownOrange!60!white, draw=white!95!black,  thick] (B2) -- (B4) -- (C4) -- (C2) --cycle;
				
				
				
				\filldraw[ownOrange!60!white, draw=white!95!black,  thick] (A1) -- (A3) -- (B3) -- (B1) --cycle;
				\filldraw[ownOrange!60!white, draw=white!95!black,  thick] (A1) -- (B1) -- (B2) -- (A2) --cycle;
				\filldraw[ownOrange!60!white, draw=white!95!black,  thick] (B1) -- (C1) -- (C2) -- (B2) --cycle;
				% 
				...
				\draw[canvas is xy plane at z = 4.5, <-, white!95!black] (0,-0.5) arc(0:270:0.5) node[midway, above] {$-\varphi$};
			...
			\draw[canvas is xy plane at z = 4.5, <-, white!95!black] (0.3,-0) arc(-90:210:0.3) node[midway,  above, xshift=4] {$-\chi$};
		\end{scope} 
		% <<
