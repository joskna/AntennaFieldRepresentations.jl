...
% ________________________________________________________________________________________________________________
 \begin{document}
	...
	\begin{tikzpicture}[thick,tdplot_main_coords, scale=0.6] % TikZ picture >>
		\sphToCart{2.5}{-30}{40}
		...
		\begin{scope}[rotate=0]
			...
			\begin{scope}[ownOrange,thick, rotate=30] % Draw in gray >>
				...
				\tdplotCsDrawLonCircle[tdplotCsBack/.style={ownOrange!50,densely dashed}]{2.5}{0}
				%  \tdplotCsDrawLonCircle{2.5}{30}
				\tdplotCsDrawLonCircle[tdplotCsBack/.style={ownOrange!50,densely dashed}, tdplotCsFront/.style={draw=none}]{2.5}{45}
				\tdplotCsDrawLonCircle[tdplotCsBack/.style={ownOrange!50,densely dashed}, tdplotCsFront/.style={draw=none}]{2.5}{90}
				%  \tdplotCsDrawLonCircle{2.5}{120}
				\tdplotCsDrawLonCircle[tdplotCsBack/.style={ownOrange!50,densely dashed}, tdplotCsFront/.style={draw=none}]{2.5}{135}
				
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={ownOrange!50,densely dashed}, tdplotCsFront/.style={draw=none}]{2.5}{-30}
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={ownOrange!50,densely dashed}, tdplotCsFront/.style={draw=none}]{2.5}{-60}
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={ownOrange!50,densely dashed}, tdplotCsFront/.style={draw=none}]{2.5}{0}
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={ownOrange!50,densely dashed}, tdplotCsFront/.style={draw=none}]{2.5}{30}
				
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={ownOrange!50,densely dashed}, tdplotCsFront/.style={draw=none}]{2.5}{60}
				
				
				\filldraw[ownOrange!40!white, draw=black,  thick] (B1) -- (B3) -- (C3) -- (C1) --cycle;
				\filldraw[ownOrange!40!white, draw=black,  thick] (B3) -- (B4) -- (C4) -- (C3) --cycle;
				
				
				\draw[densely dotted, black](0,0,-3.5) -- (0,0,5);
			\end{scope}
			
			\begin{scope}[ownBlue,thick, rotate=0, yshift=6cm] % Draw in gray >>
				...
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=black}, tdplotCsFront/.style={draw=black}, tdplotCsFill/.style={ownBlue!60!white}]{0.750}{-60}
				...
				\draw [black](0.3,-0.22,-0.5)--(0.2,-0.12,-0.11)--(0.2,-0.12,0.4);
				
				\draw [black](-0.2,0.12,0.35)--(-0.2,0.1,-0.21)--(-0.33,0.22,-0.7);
				
				
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={black}, tdplotCsFront/.style={draw=black}, tdplotCsFill/.style={ownBlue!60!white}]{0.45}{60}
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}, tdplotCsFront/.style={draw=black}]{0.250}{-30}
			...
			\begin{scope}[ownOrange,thick, rotate=30]
				\filldraw[ownOrange!60!white, draw=black,  thick] (B2) -- (B4) -- (A4) -- (A2) --cycle;
				
				\filldraw[ownOrange!60!white, draw=black,  thick] (B2) -- (B4) -- (C4) -- (C2) --cycle;
				
				
				
				\filldraw[ownOrange!60!white, draw=black,  thick] (A1) -- (A3) -- (B3) -- (B1) --cycle;
				\filldraw[ownOrange!60!white, draw=black,  thick] (A1) -- (B1) -- (B2) -- (A2) --cycle;
				\filldraw[ownOrange!60!white, draw=black,  thick] (B1) -- (C1) -- (C2) -- (B2) --cycle;
				% 
				...
				\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{2.5}{0}
				%  \tdplotCsDrawLonCircle{2.5}{30}
				\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{2.5}{45}
				\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{2.5}{90}
				%  \tdplotCsDrawLonCircle{2.5}{120}
				\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{2.5}{135}
				
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}]{2.5}{-30}
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}]{2.5}{-60}
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}]{2.5}{0}
				\tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}]{2.5}{30}
				...
				\draw[canvas is xy plane at z = 4.5, <-, black] (0,-0.5) arc(0:270:0.5) node[midway, above] {$-\varphi$};
				
				% \tdplotCsDrawLonCircle{2.5}{180}
				%  \tdplotCsDrawLonCircle[tdplotCsBack/.style={thin,ownOrange!30}]{2.5}{180}
			\end{scope}
			
			\draw[canvas is yz plane at x = 0, ->] (0,3.5) arc(90:127:3.5) node[midway, above, xshift=-2] {$-\vartheta$};
			
			\draw[canvas is xy plane at z = 4.5, <-, black] (0.3,-0) arc(-90:210:0.3) node[midway,  above, xshift=4] {$-\chi$};
		\end{scope} 
		% <<
