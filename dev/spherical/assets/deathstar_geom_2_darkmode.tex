...
% ________________________________________________________________________________________________________________
 ...
 \begin{tikzpicture}[thick,tdplot_main_coords, scale=0.8] % TikZ picture >>
 \sphToCart{2.5}{-30}{40}
...
\begin{scope}[ownOrange, ultra thick, rotate=30]
...
\pgfmathsetmacro{\thet}{40} 
\foreach \phii in {-80,-70,...,150}
{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
	\filldraw[ownBlue] (\x, \y, \z) circle(2pt);
...
\pgfmathsetmacro{\thet}{50} 
\foreach \phii in {-70,-60,...,140}
{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
	\filldraw[ownBlue] (\x, \y, \z) circle(2pt);
...
\pgfmathsetmacro{\thet}{60} 
\foreach \phii in {-60,-50,...,140}
{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
	\filldraw[ownBlue] (\x, \y, \z) circle(2pt);
...
\pgfmathsetmacro{\thet}{70} 
\foreach \phii in {-60,-50,...,130}
{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
	\filldraw[ownBlue] (\x, \y, \z) circle(2pt);
...
\pgfmathsetmacro{\thet}{80} 
\foreach \phii in {-60,-50,...,120}
{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
	\filldraw[ownBlue] (\x, \y, \z) circle(2pt);
...
\pgfmathsetmacro{\thet}{100} 
\foreach \phii in {-40,-30,...,110}
{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
	\filldraw[ownBlue] (\x, \y, \z) circle(2pt);
...
\pgfmathsetmacro{\thet}{110} 
\foreach \phii in {-30,-20,...,100}
{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
	\filldraw[ownBlue] (\x, \y, \z) circle(2pt);
...
\pgfmathsetmacro{\thet}{130} 
\foreach \phii in {-20,-10,...,90}
{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
	\filldraw[ownBlue] (\x, \y, \z) circle(2pt);
...
\pgfmathsetmacro{\thet}{140} 
\foreach \phii in {-10,0,...,80}
{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
	\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
	\filldraw[ownBlue] (\x, \y, \z) circle(2pt);
