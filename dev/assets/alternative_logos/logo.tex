	...
	\begin{tikzpicture}[ultra thick,tdplot_main_coords, scale=0.8] % TikZ picture >>
		...
		% \begin{scope}[rotate=-30]
			...
			\begin{scope}[ownOrange,ultra thick] % Draw in gray >>
				...
				\filldraw[ownOrange!40!white, draw=black,  ultra thick] (B1) -- (B3) -- (C3) -- (C1) --cycle;
				\filldraw[ownOrange!40!white, draw=black,  ultra thick] (B3) -- (B4) -- (C4) -- (C3) --cycle;
				
				\filldraw[ownOrange!60!white, draw=black,  ultra thick] (B2) -- (B4) -- (A4) -- (A2) --cycle;
				
				\filldraw[ownOrange!60!white, draw=black,  ultra thick] (B2) -- (B4) -- (C4) -- (C2) --cycle;
				
				
				
				\filldraw[ownOrange!60!white, draw=black,  ultra thick] (A1) -- (A3) -- (B3) -- (B1) --cycle;
				\filldraw[ownOrange!60!white, draw=black,  ultra thick] (A1) -- (B1) -- (B2) -- (A2) --cycle;
				\filldraw[ownOrange!60!white, draw=black,  ultra thick] (B1) -- (C1) -- (C2) -- (B2) --cycle;
...
\node at (0,8,-9){\includegraphics[scale=0.4]{logo_dipole}};			
