...
function oneoverz_deriv_sphericalHankel1(ℓ, z)
    ...
    return ((ℓ + 1) * sphericalHankel1(ℓ - 1, z) - ℓ * sphericalHankel1(ℓ + 1, z)) /
           (2 * ℓ + 1)
end
...
function oneoverz_deriv_sphericalHankel2(ℓ, z)
    # Hansen Apendix page 316
    return ((ℓ + 1) * sphericalHankel2(ℓ - 1, z) - ℓ * sphericalHankel2(ℓ + 1, z)) /
           (2 * ℓ + 1)
end
...
function oneoverz_deriv_sphericalBessel1(ℓ, z)
    # Hansen Apendix page 316
    return ((ℓ + 1) * sphericalBessel1(ℓ - 1, z) - ℓ * sphericalBessel1(ℓ + 1, z)) /
           (2 * ℓ + 1)
end
