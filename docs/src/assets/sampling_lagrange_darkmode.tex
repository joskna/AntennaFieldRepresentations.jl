...
\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{\Rcirc}{22.5}
%  \tdplotCsDrawLonCircle{2.5}{30}
\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{\Rcirc}{45}
\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{\Rcirc}{67.5}
\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{\Rcirc}{90}
\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{\Rcirc}{112.5}
%  \tdplotCsDrawLonCircle{2.5}{120}
\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{\Rcirc}{135}
\tdplotCsDrawLonCircle[tdplotCsBack/.style={draw=none}]{\Rcirc}{157.5}
...
\tdplotCsDrawLatCircle[tdplotCsBack/.style={draw=none}]{\Rcirc}{67.5}
				...
				\begin{scope}[ultra thick]
					\pgfmathsetmacro{\thet}{16.200786371436767} 
					\foreach \phii in {0,22.5,...,359}
				...
				\begin{scope}[ultra thick]
					\pgfmathsetmacro{\thet}{ 37.18705681000574} 
					\foreach \phii in {-112.5,-90,...,157.5}
					{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
						\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
						\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
						\filldraw[ownOrange] (\x, \y, \z) circle(2pt);
				...
				\end{scope}
					...
					\begin{scope}[ultra thick]
						\pgfmathsetmacro{\thet}{ 58.29590825499206} 
						\foreach \phii in {-67.5,-45,...,135}
						{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
							\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
							\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
							\filldraw[ownOrange] (\x, \y, \z) circle(2pt);
					...
					\begin{scope}[ultra thick]
						\pgfmathsetmacro{\thet}{ 79.43011768742392} 
						\foreach \phii in {-45,-22.5,...,126}
						{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
							\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
							\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
							\filldraw[ownOrange] (\x, \y, \z) circle(2pt);
				...
				\begin{scope}[ultra thick]
					\pgfmathsetmacro{\thet}{ 100.56988231257608} 
					\foreach \phii in {-45,-22.5,...,126}
					{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
						\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
						\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
				...
				\end{scope}
					...
					\begin{scope}[ultra thick]
						\pgfmathsetmacro{\thet}{121.70409174500794} 
						\foreach \phii in {-22.5,0,...,108}
						{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
							\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
							\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
							\filldraw[ownOrange] (\x, \y, \z) circle(2pt);
					...
					\begin{scope}[ultra thick]
						\pgfmathsetmacro{\thet}{142.81294318999426} 
						\foreach \phii in {0,22.5,...,67.5}
						{ \pgfmathsetmacro{\x}{{cos(\phii)*\Rcirc*sin(\thet)}}
							\pgfmathsetmacro{\y}{{sin(\phii)*\Rcirc*sin(\thet)}}
							\pgfmathsetmacro{\z}{{cos(\thet)*\Rcirc}}
							\filldraw[ownOrange] (\x, \y, \z) circle(2pt);
