...
y_aut = x_aut
    ...
    Hertzsrcdips=generate_AUTdips( collect(-λ / 4:λ / 4:λ/4),
    ...
    bsph=transmission(Hertzsrcdips, convertrepresentation(IncidentSphericalExpansion{ComplexF64}, Hertzobsdips,k0), k0)
    @test isapprox(bdips, bsph, rtol =1e-8)
    bsph=transmission(convertrepresentation(RadiatingSphericalExpansion{ComplexF64}, Hertzsrcdips,k0), Hertzobsdips,k0)
    @test isapprox(bdips, bsph, rtol =1e-8)
    ...
    bsph=transmission(Fitzsrcdips, convertrepresentation(IncidentSphericalExpansion{ComplexF64}, Hertzobsdips,k0), k0)
    @test isapprox(bdips, bsph, rtol =1e-8)
    ...
    bsph=transmission(convertrepresentation(RadiatingSphericalExpansion{ComplexF64}, Hertzsrcdips,k0), Fitzobsdips,k0)
    @test isapprox(bdips, bsph, rtol =1e-8)
