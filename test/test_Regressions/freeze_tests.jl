...
fdipole=FitzgeraldArray([[0.0, 0.0, 0.0]], [complex.([0.0, 1.0, 0.0])],[complex(1.0)], k0)
...
dR=[0.1,0.2,0.3]
shifted_hdipole=HertzArray([[0.0, 0.0, 0.0]+dR], [complex.([0.0, 0.0, 1.0])],[complex(1.0)], k0)
...
@test efield(shifted_hspherical, R+dR) ≈ efield(shifted_hdipole, R+dR) ≈ efield(hdipole, R)
