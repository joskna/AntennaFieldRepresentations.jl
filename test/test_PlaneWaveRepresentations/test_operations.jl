...
@test norm(rotatedstoredPattern.Eθ-rotatedPattern.Eθ)/norm(rotatedstoredPattern.Eθ) <1e-3
@test norm(rotatedstoredPattern.Eϕ-rotatedPattern.Eϕ)/norm(rotatedstoredPattern.Eϕ) <1e-3
...
@test norm(rotatedstoredPattern.Eθ-rotatedPattern.Eθ)/norm(rotatedstoredPattern.Eθ) <1e-6
@test norm(rotatedstoredPattern.Eϕ-rotatedPattern.Eϕ)/norm(rotatedstoredPattern.Eϕ) <1e-6
