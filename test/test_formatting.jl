...
@test format(joinpath(pkgpath,"src", "SphericalVectorModeFields", "modefunctions.jl"), overwrite=false)  
@test format(joinpath(pkgpath,"src", "SphericalVectorModeFields", "modeoperations.jl"), overwrite=false)  
@test format(joinpath(pkgpath,"src", "SphericalVectorModeFields", "normalizedlegendre.jl"), overwrite=false)
...
@test format(joinpath(pkgpath,"src", "FastSphericalVectorModeTransformations","wacker.jl"), overwrite=false)
...
@test format(joinpath(pkgpath,"src", "MLFMMTree","AbstractMLFMMTree.jl"), overwrite=false)
